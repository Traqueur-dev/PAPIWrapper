...
public class Updater {
    ...
    public static void checkUpdates() {
        if(!Updater.isUpToDate()) {
            Logger.getLogger("PAPIWrapper").warning("The framework is not up to date, the latest version is " + Updater.fetchLatestVersion());
        }
    }
    ...
    public static String getVersion() {
        ...
        try {
            prop.load(Updater.class.getClassLoader().getResourceAsStream("papiwrapper.properties"));
    ...
    public static String fetchLatestVersion() {
        try {
            URL url = URI.create("https://api.github.com/repos/Traqueur-dev/PAPIWrapper/releases/latest").toURL();
